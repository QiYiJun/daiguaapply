<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>小阅阅阅读</el-breadcrumb-item>
    </el-breadcrumb>

    <el-card>
      <div class='tips'>小阅阅阅读</div>
      <div class="teach">
        <el-button type="primary"
                   @click="teachDialogVisible = true">查看教程</el-button>
      </div>

      <el-form :model="XiaoYueYueForm"
               :rules="XiaoYueYueRules"
               ref="XiaoYueYueRef"
               label-width="128px">
        <el-form-item label="WxPusher_UID"
                      prop="wxpusher_uid">
          <el-input v-model="XiaoYueYueForm.wxpusher_uid"
                    placeholder='wxpusher_uid示例: UID_xxxxxxxxxx'></el-input>
        </el-form-item>
        <el-form-item label="Cookie"
                      prop="cookie">
          <el-input v-model="XiaoYueYueForm.cookie"
                    placeholder='cookie示例(一整个cookie复制粘贴就对了): oZdBp0xxxxxxxxxxxxxx'></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary">立即创建</el-button>
          <el-button @click="resetForm('XiaoYueYueRef')">重置</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    ...
    <el-dialog title="教程"
      ...
      <span>抓取域名"1692433047.3z2rpa.top"下的 cookie 完整复制下来</span>
